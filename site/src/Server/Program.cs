...
public class InMemoryProjectRepo : IProjectRepository
{
    private readonly Project[] _projects = {
        new(Guid.Parse("EBFF4563-6354-40CB-A5C4-B898593CB09D"), "Software Architect", "Test Description", "something", new DateOnly(2021,1,1), null, new []{"C#", "Azure", "React", "Terraform", "Docker", "AWS", "Azure DevOps", "Kanban", ""}),
